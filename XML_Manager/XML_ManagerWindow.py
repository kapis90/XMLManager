...
class Ui_XMLManager(object):
    def setupUi(self, XMLManager):
        ...
        self.IteratonEdit = QtGui.QLineEdit(self.AddTestcaseBox)
        self.IteratonEdit.setGeometry(QtCore.QRect(70, 30, 151, 20))
        self.IteratonEdit.setObjectName(_fromUtf8("IteratonEdit"))
